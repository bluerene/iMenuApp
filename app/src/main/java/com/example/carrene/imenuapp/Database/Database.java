package com.example.carrene.imenuapp.Database;
...
/**
 * Created by carrene on 11/6/2018.
 */

public class Database extends SQLiteAssetHelper {

    private static final String DB_NAME = "iMenuDB.db";
    ...
    public void addToFavorites(Favorites food)
    {
        ...
        String query = String.format("INSERT INTO Favorites(" +
                "FoodId,FoodName,FoodPrice,FoodMenuId,FoodImage,FoodDescription,FoodCalorie,UserPhone) " +
    ...
    public List<Favorites> getAllFavorites(String userPhone)
    {
        ...
        String [] sqlSelect = {"UserPhone","FoodId","FoodName","FoodPrice","FoodMenuId","FoodImage","FoodDescription","FoodCalorie"};
        ...
        if (c.moveToFirst())
        {
            do
            {
                result.add(new Favorites(
                        ...
                        c.getString(c.getColumnIndex("FoodCalorie")),
                        c.getString(c.getColumnIndex("UserPhone"))
                ));
            }while (c.moveToNext());
